...
This repository holds an example backend for the Ingestion API [Safeplaces API specification](https://github.com/Path-Check/safeplaces-backend-ingest/blob/dev/openapi.yaml).
